...
// Restrict access to logged-in clients only
if (!isset($_SESSION['login_id']) || $_SESSION['usertype_id'] != 2) {
    echo "<script>alert('Access denied. Clients only.'); window.location.href='../index.php';</script>";
    exit();
}
?>
...
while ($room = mysqli_fetch_assoc($result)) {
    ...
    <div class="col-lg-4 col-md-6 my-3">
        <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
            <img src="' . htmlspecialchars($room['photo_path']) . '" class="card-img-top">
            <div class="card-body">
